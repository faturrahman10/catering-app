...
<head>
    ...
    <title>Konfirmasi Password - {{ config('app.name', 'CateringApp') }}</title>
            ...
            <div class="hidden lg:block animate-fade-in-up space-y-8">
                ...
                <div class="space-y-6">
                    <h2 class="text-3xl font-bold leading-tight">
                        Area Aman<br>
                        <span class="gradient-text">Verifikasi Diperlukan</span>
                    </h2>

                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                        Anda akan mengakses area yang memerlukan keamanan tinggi. Silakan konfirmasi password Anda
                        untuk melanjutkan.
                    </p>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start space-x-4 group">
                            ...
                            <div>
                                <h3 class="font-semibold mb-1">Keamanan Berlapis</h3>
                                <p class="text-sm text-gray-600 dark:text-gray-400">Proteksi ekstra untuk data
                                    sensitif Anda</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4 group">
                            ...
                            <div>
                                <h3 class="font-semibold mb-1">Verifikasi Cepat</h3>
                                <p class="text-sm text-gray-600 dark:text-gray-400">Hanya butuh beberapa detik untuk
                                    konfirmasi</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4 group">
                            ...
                            <div>
                                <h3 class="font-semibold mb-1">Akses Terjamin</h3>
                                <p class="text-sm text-gray-600 dark:text-gray-400">Password benar = langsung akses
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="glass-effect rounded-2xl p-6">
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            <h3 class="font-semibold mb-1 text-sm">Kenapa Perlu Konfirmasi?</h3>
                            <p class="text-xs text-gray-600 dark:text-gray-400">
                                Beberapa fitur seperti pengaturan akun, metode pembayaran, dan data pribadi memerlukan
                                verifikasi tambahan untuk menjaga keamanan Anda.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <!-- Protected Areas -->
                <div class="space-y-2">
                    <p class="text-sm font-semibold text-gray-700 dark:text-gray-300">Area yang Dilindungi:</p>
            ...
            <div class="animate-slide-in-right">
                <div class="glass-effect rounded-3xl p-8 md:p-12 shadow-2xl">
                    ...
                    <div class="text-center mb-8">
                        <div
                            class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-orange-100 dark:bg-orange-900/30 mb-4">
                        ...
                        <h2 class="text-3xl font-bold mb-2">Konfirmasi Password</h2>
                        <p class="text-gray-600 dark:text-gray-400">
                            Ini adalah area aman aplikasi. Silakan konfirmasi password Anda untuk melanjutkan.
                        </p>
                    </div>

                    <!-- Security Notice -->
                    <div
                        class="mb-6 p-4 rounded-xl bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800">
                        <div class="flex items-start">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-xs text-yellow-600 dark:text-yellow-400">
                                    Untuk melindungi data Anda, kami memerlukan konfirmasi password sebelum mengakses
                                    area sensitif.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center justify-center space-x-4 text-sm">
                            ...
                            <form method="POST" action="{{ route('logout') }}" class="inline">
                                @csrf
                                <button type="submit"
                                    class="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200 font-semibold transition-colors">
                                    Keluar
                                </button>
                            </form>
                        </div>
