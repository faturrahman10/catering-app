    ...
    <div class="p-4 md:p-6 lg:p-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8">
            ...
            <div
                ...
                <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ number_format($todayOrders) }}</p>
            </div>
            ...
            <div
                ...
                <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ number_format($activeMenus) }}</p>
            </div>
        ...
        <div
            ...
            <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-0.5">Daftar transaksi terbaru dari pelanggan
                    </p>
                </div>
