<x-app-layout>
    ...
    <div class="p-4 md:p-6 lg:p-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-sm md:text-base">
                        Catat pengeluaran bisnis Anda dengan detail
                    </p>
                </div>
        ...
        <div class="max-w-4xl mx-auto" x-data="expenseForm()">
            <div
                ...
                <form action="{{ route('finance.expenses.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-lg p-6">
                        ...
                        <button type="button" @click="addItem()"
                            class="mt-4 w-full py-3 border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-lg 
                                   text-gray-600 dark:text-gray-400 hover:border-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400
                    ...
                    {{-- Upload Bukti --}}
                    <div>
                        <x-input-label for="receipt_image" value="Upload Bukti/Nota (Opsional)" />
                        ...
                        <div class="mt-1">
                            ...
                            <label x-show="!imagePreview" for="receipt_image"
            ...
            {{-- Info Card --}}
            <div
                class="mt-6 bg-gradient-to-r from-red-50 to-orange-50 dark:from-red-900/20 dark:to-orange-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                <div class="flex gap-3">
                    ...
                    <div class="text-sm text-red-800 dark:text-red-300">
                        <p class="font-medium mb-1">Tips Mencatat Pengeluaran:</p>
                        <ul class="list-disc list-inside space-y-1 text-xs">
                            <li>Catat semua pengeluaran dengan detail untuk akurasi laporan</li>
                            <li>Simpan bukti/nota untuk audit dan perpajakan</li>
                            <li>Kategorikan dengan tepat agar analisis lebih mudah</li>
