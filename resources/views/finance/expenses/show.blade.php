            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-sm md:text-base">
                        Informasi lengkap pengeluaran bisnis
                    </p>
                </div>
        ...
        <div class="max-w-5xl mx-auto space-y-6">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-6">
                <div class="flex flex-col md:flex-row gap-6">
                    ...
                    <div class="flex-shrink-0">
                        <div
                            class="w-32 h-32 rounded-2xl bg-gradient-to-br from-red-500 to-orange-500 flex items-center justify-center">
                        ...
                        @foreach ($expense->items as $index => $item)
                            <div
                                ...
                                <div class="flex items-start justify-between mb-3">
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="w-8 h-8 rounded-lg bg-gradient-to-br from-red-500 to-orange-500 flex items-center justify-center">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                @if ($expense->receipt_image)
                    <div
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Bukti/Nota</h3>
            ...
            <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-900 dark:text-white">
                            {{ $expense->created_at->format('d F Y H:i') }}
                        </p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-500 dark:text-gray-400">Terakhir Diupdate</p>
                        <p class="text-sm font-medium text-gray-900 dark:text-white">
                            {{ $expense->updated_at->format('d F Y H:i') }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center justify-end gap-3">
                <form action="{{ route('finance.expenses.destroy', $expense) }}" method="POST"
                    onsubmit="return confirm('Yakin ingin menghapus pengeluaran ini? Data yang dihapus tidak dapat dikembalikan.')"
                    class="inline">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
