...
<head>
    ...
    <script>
        // Check dark mode preference before page loads to prevent flash
...
<body class="font-sans antialiased">
    ...
    }" x-init="// Watch for dark mode changes
    ...
    if (darkMode) {
        ...
        {{-- Integrated Navigation + Sidebar Layout --}}
        <div class="flex min-h-screen">
            ...
            <div x-show="sidebarOpen" @click="sidebarOpen = false"
                ...
                class="fixed inset-0 z-40 bg-gray-900/80 lg:hidden" style="display: none;">
            </div>
            ...
            <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
                ...
                {{-- Header --}}
                <div
                    class="h-16 flex items-center justify-between px-6 border-b border-gray-200 dark:border-gray-800 flex-shrink-0">
