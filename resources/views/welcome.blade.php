        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="#menu"
                        class="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Menu</a>
                    <a href="#cara-kerja"
                        class="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Cara Pesan</a>
                    <a href="#testimoni"
                        class="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Testimoni</a>
                    <a href="#paket"
                        class="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Paket</a>

                    <!-- Theme Toggle -->
                    <button @click="toggle()"
                        class="p-2 rounded-lg hover:bg-white/50 dark:hover:bg-gray-700/50 transition-all">
                    ...
                    <a href="{{ route('login') }}"
                        class="px-6 py-2.5 rounded-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300">
                        Pesan Sekarang
                    </a>
                </div>
                ...
                <button @click="mobileMenu = !mobileMenu"
                    class="md:hidden p-2 rounded-lg hover:bg-white/50 dark:hover:bg-gray-700/50">
